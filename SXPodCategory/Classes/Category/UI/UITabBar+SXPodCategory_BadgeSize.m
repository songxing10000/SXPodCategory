 ...
 */
static const CGFloat kTabbarItemNums = 3.0;

@implementation UITabBar (SXPodCategory_BadgeSize)
...
- (void)showBadgeOnItemIndex:(int)index{
    ...
    CGFloat x = ceilf(percentX * tabFrame.size.width)-4;// 更近一点
